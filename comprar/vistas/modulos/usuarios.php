    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:#000; color:white">
          ...
          <button type="button" style="background:red;color:white" class="close" data-dismiss="modal">&times;</button>
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <div class="panel" style="background:#000;">SUBIR FOTO</div>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:#000;">
          ...
          <h4 class="modal-title" style="background:#000;">Editar usuario</h4>
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <div class="panel" style="background:#000; color:white">SUBIR FOTO</div>
