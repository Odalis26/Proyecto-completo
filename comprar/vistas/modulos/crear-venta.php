 ...
 <!--=====================================
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-addon"><i class="fa fa-user" style="background:black; color:black"></i></span>

                    <input type="text" class="form-control" id="nuevoVendedor" value="<?php echo $_SESSION["nombre"]; ?>" style="background:black; color:black" readonly>

                    <input type="hidden" name="idVendedor" value="<?php echo $_SESSION["id"]; ?>" style="background:black; color:black">
