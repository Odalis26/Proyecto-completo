  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body" style="background:#000; color:white">
          ...
          <div class="box-body">
             ...
             <div class="form-group row">
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control input-lg" id="nuevoPrecioVenta" name="nuevoPrecioVenta" step="any" min="0" placeholder="Precio de venta" style="background:#000; color:white" required>
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <div class="panel" style="background:#000;">SUBIR IMAGEN</div>

              <input type="file" class="nuevaImagen" name="nuevaImagen">

              <p class="help-block">Peso máximo de la imagen 2MB</p>

              <img src="vistas/img/plantilla/omnilife.png" class="img-thumbnail previsualizar" width="100px">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body" style="background:black; color:white">
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <div class="panel" style="background:black; color:white">SUBIR IMAGEN</div>
